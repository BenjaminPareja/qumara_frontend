...
import appteam.nith.hillffair.retrofit.QumaraAdapter;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<PacienteResponse> call = QumaraAdapter.getApiService().getPaciente(dni);
        call.enqueue(new PacientesCallback());
...
/*        recyclerView = (RecyclerView) findViewById(R.id.list);
    ...
    class PacientesCallback implements Callback<PacienteResponse>{
